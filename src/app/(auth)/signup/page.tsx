...
const page = async () => {
  ...
  return (
    // Forced dark-but-not-black background (Slate 900)
    <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden bg-slate-900 font-sans text-slate-200">
      ...
      {/* 1. Subtle Developer Grid Pattern (Faint white lines for dark bg) */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff08_1px,transparent_1px),linear-gradient(to_bottom,#ffffff08_1px,transparent_1px)] bg-[size:24px_24px]"></div>
      
      {/* 2. Ambient Glowing Orbs to draw focus to the center */}
      ...
      {/* Frosted Glass Card - slightly lighter than the background to create depth */}
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          >
            ...
            <h1 className="text-2xl font-extrabold tracking-tight text-white">
              Join <span className="text-orange-500 italic">N8N</span>
            </h1>
          </Link>
